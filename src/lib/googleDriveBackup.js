      ...
      tokenClient = window.google.accounts.oauth2.initTokenClient({
        ...
        callback: async (response) => {
          ...
          if (!hasDriveScope) {
            ...
            const errorMsg = `❌ ERROR: El token no incluye el scope de Google Drive necesario.\n\n📋 Scopes solicitados:\n${requestedScopes}\n\n📋 Scopes recibidos:\n${grantedScopes}\n\n🔍 CAUSA PROBABLE:\nEl scope de Google Drive no está habilitado en la pantalla de consentimiento de OAuth en Google Cloud Console.\n\n✅ SOLUCIÓN PASO A PASO:\n\n1️⃣ Verifica que Google Drive API esté habilitada:\n   👉 https://console.cloud.google.com/apis/library/drive.googleapis.com\n   - Busca "Google Drive API"\n   - Si no está habilitada, haz clic en "ENABLE"\n\n2️⃣ Ve a la pantalla de consentimiento:\n   👉 https://console.cloud.google.com/apis/credentials/consent\n\n3️⃣ En la sección "Scopes", haz clic en "ADD OR REMOVE SCOPES"\n\n4️⃣ Busca y marca estos scopes:\n   ✅ https://www.googleapis.com/auth/drive.file\n   ✅ https://www.googleapis.com/auth/userinfo.email\n   ✅ https://www.googleapis.com/auth/userinfo.profile\n   ✅ openid\n\n5️⃣ Haz clic en "UPDATE" y luego en "SAVE AND CONTINUE"\n\n6️⃣ Si la app está en modo "Testing":\n   - Ve a "Test users"\n   - Asegúrate de que tu cuenta esté en la lista\n   - Si no está, haz clic en "ADD USERS" y agrega tu email\n\n7️⃣ Espera 5-10 minutos para que los cambios se propaguen\n\n8️⃣ IMPORTANTE: Revoca los permisos anteriores:\n   👉 https://myaccount.google.com/permissions\n   - Busca "POS Sistema" o tu app\n   - Haz clic en "Remove access"\n\n9️⃣ Recarga la página completamente (Ctrl+F5)\n\n🔟 Intenta conectar nuevamente\n\n💡 TIP: Si después de seguir estos pasos sigue fallando, verifica que el Client ID sea correcto:\n   ${CLIENT_ID}`;
